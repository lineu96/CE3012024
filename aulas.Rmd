...
**Semana 13**
 ...
 - 20/05/24 (seg) - [Introdução à inferência](slides/400-intro-inferencia.pdf) e [exercícios](praticas-aula/401-intro-inferencia-dist-amostral-enunciado.pdf).
 - 22/05/24 (qua) - Estimação pontual e intervalar e exercícios.
    
**Semana 14**

 - 27/05/24 (seg) - Tamanho amostral + Exercícios.
 - 29/05/24 (qua) - Prática em R.

**Semana 15**

 - 03/05/24 (seg) - Introdução aos testes de hipóteses e testes para uma população e exercícios.
 - 05/05/24 (qua) - Prática em R.
    
**Semana 16**

 - 10/06/24 (seg) - Tira dúvidas/exercícios/dinâmica (a definir). 
 - 12/06/24 (qua) - Tira dúvidas/exercícios/dinâmica (a definir).
