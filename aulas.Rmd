...
**Semana 13**
 ...
 - 20/05/24 (seg) - [Introdução à inferência](slides/400-intro-inferencia.pdf) e [exercícios](praticas-aula/400-intro-inferencia-dist-amostral-enunciado.pdf).
 - 22/05/24 (qua) - [Estimação pontual e intervalar](slides/401-estimacao-pontual-intervalar.pdf) e [exercícios](praticas-aula/401-intervalo-de-confianca-enunciado.pdf).
    
**Semana 14**

 - 27/05/24 (seg) - [Tamanho amostral](slides/402-tamanho-amostral.pdf), [exercícios](praticas-aula/402-tamanho-amostral-enunciado.pdf) e prática em R.
 - 29/05/24 (qua) - [Introdução aos testes de hipóteses, testes para uma população](slides/403-testes-de-hipoteses.pdf) e [exercícios](praticas-aula/403-teste-de-hipoteses-enunciado.pdf).

**Semana 15**

 - 03/05/24 (seg) - Exercícios e prática em R.
 - 05/05/24 (qua) - Tira dúvidas/exercícios/dinâmica (a definir).
    
**Semana 16**

 - 10/06/24 (seg) - **PROVA 4** (possível data).
 - 12/06/24 (qua) - **PROVA 4** (possível data).
