...
**Semana 14**
 ...
 - 29/05/24 (qua) - [Tamanho amostral](slides/402-tamanho-amostral.pdf), [exercícios](praticas-aula/402-tamanho-amostral-enunciado.pdf) e prática em R.

**Semana 15**

 - 03/05/24 (seg) - [Introdução aos testes de hipóteses, testes para uma população](slides/403-testes-de-hipoteses.pdf) e [exercícios](praticas-aula/403-teste-de-hipoteses-enunciado.pdf).
 - 05/05/24 (qua) - Exercícios e prática em R.
    
**Semana 16**

 - 12/06/24 (qua) - **PROVA 4** (possível data).
 - 14/06/24 (sex) - **PROVA 4** (possível data).
