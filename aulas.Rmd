...
**Semana 2**
 ...
 - 07/03/24 (qui) - [Atividade prática amostragem](slides/102-exercicios-enunciados.pdf).
...
**Semana 13**
 ...
 - 13/05/24 (seg) - Introdução à inferência.
 - 14/05/24 (ter) - Exercícios distribuição amostral.
 - 16/05/24 (qui) - Dinâmica.
 - 17/05/24 (sex) - Prática em R
    
**Semana 14**

 - 20/05/24 (seg) - Estimação pontual e intervalar.
 - 21/05/24 (ter) - Tamanho amostral + Exercícios.
 - 23/05/24 (qui) - Dinâmica.
 - 24/05/24 (sex) - Prática em R.
    
**Semana 15**

 - 27/05/24 (seg) - Introdução aos testes de hipóteses e testes para uma população.
 - 28/05/24 (ter) - Exercícios.
 - 30/05/24 (qui) - **Feriado: Corpus Christi.**
 - 31/05/24 (sex) - **Feriado: Corpus Christi.**
    
**Semana 16**

 - 03/06/24 (seg) - Tira dúvidas/exercícios/dinâmica (a definir).
 - 04/06/24 (ter) - Tira dúvidas/exercícios/dinâmica (a definir).
 - 06/06/24 (qui) - **PROVA 4** (possível data).
 - 07/06/24 (sex) - **PROVA 4** (possível data).
